...
#Round and clean up
Totalstats18$puntPctFV <- round(Totalstats18$puntPctFV, 2)
relevantTot18$puntPctFV  <- round(relevantTot18$puntPctFV, 2)
Totalstats18$puntASTFV  <- round(Totalstats18$puntASTFV, 2)
relevantTot18$puntASTFV  <- round(relevantTot18$puntASTFV, 2)
