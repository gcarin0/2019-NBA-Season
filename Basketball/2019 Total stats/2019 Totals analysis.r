...
#set work directory
setwd("C:/Users/Giancarlo/Desktop/R/Projects/Basketball/2019 Total stats")

#Load data
Totalstats <- read_csv("2019 Totals.csv")
...
puntPctFV <- Totalstats[c(1:5, 7, 9, 11:12, 19, 23:26, 29, 50)]
zpuntPctFV <- Totalstats[c(1:5, 7, 30:32, 34, 37, 44, 46:50)]
puntPctFVrelev <- relevantTot[c(1:5, 7, 9, 11:12, 19, 23:26, 29, 50)]
zpuntPctFVrelev <- relevantTot[c(1:5, 7, 30:32, 34, 37, 44, 46:50)]

#New Table with Fantasy Value stats
puntASTFV <- Totalstats[c(1:5, 7, 9, 11:12, 19, 23, 25:26, 29, 51)]
zpuntASTFV <- Totalstats[c(1:5, 7, 30:32, 34, 37, 44, 46, 48:49, 51)]
puntASTFVrelev <- relevantTot[c(1:5, 7, 9, 11:12, 19, 23, 25:26, 29, 51)]
zpuntASTFVrelev <- relevantTot[c(1:5, 7, 30:32, 34, 37, 44, 46, 48:49, 51)]
...
write_csv(puntPctFV, "puntPctFV20.csv")
write_csv(puntPctFVrelev, "puntPctFVrelev19.csv")
write_csv(puntASTFV, "puntASTFV19.csv")
write_csv(puntASTFVrelev, "puntASTFVrelev19.csv")
